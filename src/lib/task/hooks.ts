...
/** The command to run when Claude tries to stop (used for both step and orchestrator) */
 ...
 * which verifies completion based on context:
 * - For orchestrator (CM_ORCHESTRATOR=true): checks for orchestrator decision
 * - For step execution: checks for step completion/failure and uncommitted changes
 */
